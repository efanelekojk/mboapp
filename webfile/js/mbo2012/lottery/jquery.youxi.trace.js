;(function($){//start
    ...
    $.fn.lt_trace = function(){
        ...
        $.each($.lt_issues.today,function(i,n){
			ii++;
            issueshtml += '<tr id="tr_trace_'+n.issue+'"><td align="center"><input type="checkbox" name="lt_trace_issues[]" value="'+n.issue+'" /></td><td align="center">'+ii+'</td><td align="center">'+n.issue+'</td><td align="center"><input style="width:100px" name="lt_trace_times_'+n.issue+'" type="text" class="input02" value="0" disabled/>'+lot_lang.dec_s2+'</td><td align="center">'+lot_lang.dec_s20+'<span id="lt_trace_money_'+n.issue+'">0.00</span></td><td align="center">'+n.endtime+'</td></tr>';
        });
